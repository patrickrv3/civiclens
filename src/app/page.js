      ...
      <section>
        <header className={styles.sectionHeader}>
          ...
          <div className={styles.feedControls}>
            ...
            <div className={styles.sortControl} style={{ position: 'relative' }}>
            ...
            {showFeedInfo && (
              <div style={{
                ...
                fontSize: '0.82rem', lineHeight: 1.5, color: 'var(--cl-text-primary, #e0e0e0)',
              }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                  <strong style={{ fontSize: '0.85rem' }}>ℹ️ About this feed</strong>
                  <button onClick={() => setShowFeedInfo(false)} style={{ background: 'none', border: 'none', color: 'var(--cl-text-secondary, #999)', cursor: 'pointer', fontSize: '1rem', padding: '0 4px' }}>✕</button>
                </div>
                ...
                <p style={{ margin: 0, color: 'var(--cl-text-secondary, #888)', fontSize: '0.78rem' }}>
